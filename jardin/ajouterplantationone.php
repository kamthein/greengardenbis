...
<form action="ajouterplantationone.php" method="post" enctype="multipart/form-data">
...
<a href="ajouterplantationtwo.php">Pas de photo</a>
    ...
    if(!empty($_FILES["image"]["name"])) { 
        ...
        if(in_array($fileType, $allowTypes)){ 
            ...
            if(isset($insert)){ 
                ...
                header('Location: ajouterplantationtwo.php?codephoto='.$codehome);
            }else{ 
